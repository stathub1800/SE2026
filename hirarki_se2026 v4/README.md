...
**Riwayat perubahan struktur yang sudah ditangani.** FASIH beberapa kali mengubah susunan ekspor.
Semua sudah diakomodasi dan dicatat di sini agar jelas bila terjadi lagi:

| Tanggal | Perubahan | Dampak |
|---|---|---|
| 16 Agu 2026 | Grup `CAWI/UB` dan `CAPI` jadi `UB` dan `UMKM`, disisipi kolom subtotal | kolom sesudahnya bergeser 2 posisi |
| 19 Agu 2026 | Kolom `Open` dirinci UB, UM, UMK, Keluarga | Open jadi angka resmi, bukan hitungan sisa |
| 23 Agu 2026 | Draft dan Open diberi tanda bintang, kondef ditulis di dalam berkas | identitas penjumlahan tidak lagi dijamin FASIH |
| 27 Agu 2026 | Grup `UMKM` jadi `DOOR-TO-DOOR (UMKM)`; kolom `Anggota Keluarga Khusus` dihapus; Keluarga Khusus dipecah jadi K1 menetap dan K2 berpindah-pindah | pola pencarian kolom disesuaikan |
